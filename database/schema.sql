...
-- Confidential training feedback (one response per enrollment)
...
-- Manual certificate release below certificate enrolment pass mark (recorded justification)
...
-- Trainer notifications: certificate enrolment test completed, marks not yet released
